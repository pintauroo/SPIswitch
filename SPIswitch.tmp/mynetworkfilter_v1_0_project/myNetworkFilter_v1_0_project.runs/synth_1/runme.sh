...
HD_PWD='c:/users/andrea/desktop/spiswitch/spiswitch.tmp/mynetworkfilter_v1_0_project/myNetworkFilter_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myNetworkFilter_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myNetworkFilter_v1_0.tcl
